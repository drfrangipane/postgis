...
#define POSTGIS_LIB_VERSION 1.5.2
#define POSTGIS_LIBXML2_VERSION 2.7.7
...
#define _POSTGIS_SQL_SELECT_POSTGIS_BUILD_DATE 'SELECT ''2010-09-27 15:19:05''::text AS version'
#define _POSTGIS_SQL_SELECT_POSTGIS_SCRIPTS_VERSION 'SELECT ''1.5 r5976''::text AS version'
